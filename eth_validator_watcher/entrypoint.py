...
class ValidatorWatcher:
    ...
    def run(self) -> None:
        ...
        while True:
            ...
            logging.info('⚠️ Not processing validator liveness')
            if False and validators_liveness == None or (slot % self._spec.data.SLOTS_PER_EPOCH == SLOT_FOR_MISSED_ATTESTATIONS_PROCESS):
